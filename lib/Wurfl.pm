...
sub AUTOLOAD {
    ...
    croak "&Wurfl::constant not defined" if $constname eq 'constant';
...
Wurfl - Perl extension for libwurfl
...
=head1 SYNOPSIS
  ...
  Wurfl::Device documentation for a list of methods
...
Returns a Wurfl::Device object representing the best match for the provided useragent string

=item * get_device ($id)

Returns a new Wurfl::Device object for the provided device id (if any)
